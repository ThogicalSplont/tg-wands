...
public class TGWands {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "tgwands" namespace
    ...
    // Creates a new Block with the id "tgwands:example_block", combining the namespace and path
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("example_block", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
    // Creates a new BlockItem with the id "tgwands:example_block", combining the namespace and path
